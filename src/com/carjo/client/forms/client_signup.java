...
public class client_signup extends BaseLogin {
...
//    APIs api = new APIs();
    ...
    public client_signup(com.codename1.ui.util.Resources resourceObjectInstance) {
        initGuiBuilderComponents(resourceObjectInstance);
        /// ...
    }

    public client_signup(com.codename1.ui.util.Resources res, Form frm) {
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    ...
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        setScrollableY(true);
                setInlineStylesTheme(resourceObjectInstance);
        setTitle("client_signup");
        setName("client_signup");
...
//        }
    ...
    private void installFixItems() {
        ...
        date = PickerComponent.createDate(new Date());
